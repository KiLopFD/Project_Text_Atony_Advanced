...
var t = window.addEventListener('load', () =>
{
    ...
    class Particle
    {
        constructor(effect,x,y,color) {
            ...
            this.y = this.effect.canvasHeight; // height
            this.color = color;
            this.originX = x;
            this.originY = y;
        ...
        update() {
            ...
            {
                this.angle = Math.atan2(this.dy, this.dy);
            ...
            else
            {
                ...
                // this.y -=(this.vy *= this.friction) +(this.originY - this.y)*0.0001;
            }
            this.x += (this.vx *= this.friction) + (this.originX - this.x) * this.ease;
